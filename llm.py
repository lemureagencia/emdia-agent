...
{{"action": "registrar|consultar|definir_saldo|ajuda",
 ...
 "due_date": "YYYY-MM-DD",
 "balance": number,
 "consulta": "saldo|a_receber|a_pagar|vencidos|metas|tudo|lista_receber|lista_pagar",
...
- Em consultar, preencha "consulta" com o que foi pedido:
  - "saldo" (saldo na conta), "a_receber" (total a receber no mês), "a_pagar" (total a pagar no mês), "vencidos", "metas", "tudo" (resumo geral / "como tá minha grana").
...
def _rule_interpret(text: str) -> dict:
    ...
    if any(k in t for k in ["saldo", "quanto tenho", "quanto devo", "resumo", "relatorio", "relatório", "como estou", "como ta", "grana", "a receber", "a pagar", "metas", "vencid"]):
